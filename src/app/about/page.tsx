    ...
    <div className="max-w-screen-lg mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-700 mt-4">
          Welcome to QAFIX Blog, your go-to destination for everything related to modern web development, design, and emerging technologies. Whether you're a beginner or an advanced professional, our blog is designed to help you stay up-to-date with the latest trends, tools, and techniques in the tech world.
          <br />
          <br />
      ...
      <div className="mt-12">
        ...
        <p className="text-lg text-gray-700 mt-4">
          Hello! I'm Qaimudin Khuwaja, a passionate Frontend Developer with a deep love for building interactive and visually appealing web applications. I am student at GIAIC where I am exploring AgenticAI and GenAI and currently, I am student of class first year.
          <br />
          <br />
