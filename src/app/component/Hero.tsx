  ...
  return (
    <>
      <div className='mt-[60px] mb-[60px]'>
        ...
        {/* Card Container */}
        <div className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 place-items-center mt-[20px] gap-[20px]'>
          ...
          <div className='bg-white shadow-xl rounded-lg overflow-hidden transform transition-all hover:scale-105 hover:shadow-2xl'>
            ...
            <div className='bg-white shadow-xl rounded-lg overflow-hidden transform transition-all hover:scale-105 hover:shadow-2xl'>
            <div className='py-7 px-5'>
              <h1 className='text-[22px] text-blue-950 font-bold mb-4'>FAQ's</h1>
              <p className='text-[16px] text-gray-600 mb-6'>
